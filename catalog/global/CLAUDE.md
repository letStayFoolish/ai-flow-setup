...
Auto-generated by `npm run catalog:build` from `catalog/global/rules/*.md` —
do not edit the table below by hand, edit the rule files' "Applies when:"
line instead.

<!-- RULES-INDEX:START -->
| Rule file | When it applies |
| --- | --- |
| `rules/api-conventions.md` | creating or modifying controllers, endpoints, request/response types, or auth decorators. |
| `rules/api-design.md` | designing new endpoints, resource shapes, versioning strategy, or response contracts. |
| `rules/clean-code.md` | writing, modifying, or reviewing any code. |
| `rules/code-style.md` | writing or reviewing any C# code. |
| `rules/design-patterns.md` | designing a module, choosing where behaviour lives, or reviewing a change that introduces (or should introduce) an abstraction. |
| `rules/dotnet-conventions.md` | creating or modifying any C# file. |
| `rules/ef-core.md` | writing or reviewing any LINQ query, repository method, entity configuration, or migration. |
| `rules/git-workflow.md` | creating branches, writing commit messages, staging changes, or opening pull/merge requests. |
| `rules/react-conventions.md` | creating or modifying React components, hooks, or frontend build configuration. |
| `rules/security.md` | writing auth logic, handling configuration, processing user input, or dealing with sensitive data. |
| `rules/testing.md` | writing tests or setting up test projects. |
<!-- RULES-INDEX:END -->
